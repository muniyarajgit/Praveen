# -*- coding: utf-8 -*-
"""
Created on Fri May 31 08:55:23 2019
...
data = pd.read_excel('PROD_DUMP_1.xlsx')
...
export_excel = data.to_excel ('Classified_PROD_DUMP_1.xlsx', index = None, header=True)
